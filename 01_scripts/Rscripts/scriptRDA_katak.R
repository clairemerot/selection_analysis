...
data_env<-read.table(paste0("03_rda/",folder,"/env_rda"), header=TRUE)
...
jpeg(file=paste0("03_rda/",folder,"/rda_1-2_1-3.jpg"))
par(mfrow=c(1,2))
...
pdf(file=paste0("03_rda/",folder,"/hist_loadings.pdf"))
par(mfrow=c(1,3))
...
write.table(cand, paste0("03_rda/",folder,"/candidate_SNP.txt"), quote=F, sep=" ")
...
# axes 1 & 2
jpeg(paste0("03_rda/",folder,"/rda_SNP.jpg"))
#par(mfrow=c(1,2))
...
signif.axis
write.table(signif.axis, paste0("03_rda/",folder,"/signifaxisrda.txt"))
