...
jpeg(paste0("lfmm_pval",ENV,"K",K_VAL,".jpg"))
par(mfrow = c(2,1))
...
write.table(snp_p_val, paste0("pvalues_snp",ENV,"K",K_VAL,".txt"))
...
write.table(snp_candidate_info, paste0("outliers_snp",ENV,"K",K_VAL,".txt"))
